 ...
 * @version 1.0
 */
@WebServlet("/sManagerServlet")
public class SManagerServlet extends BaseServlet{
    ...
    public String getMyLogs(HttpServletRequest request, HttpServletResponse response){
        ...
        sellLogs = sellLogService.selectLogByPId(pid);
    ...
    public String getMyClients(HttpServletRequest request, HttpServletResponse response){
        ...
        try {
            clients = clientService.getClientsByPId(pid);
        } catch (Exception e) {
    ...
    public String getAllPeople(HttpServletRequest request, HttpServletResponse response){
        People user = (People) request.getSession().getAttribute("user");
