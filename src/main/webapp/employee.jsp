...
<body>
<h1>欢迎 销售员 ${user.getName()}</h1>
<hr>

<div class="navbar">
    <a href="${pageContext.request.contextPath}/employeeServlet?method=getAllCars">查看车辆仓库</a>
    <a href="${pageContext.request.contextPath}/employeeServlet?method=getMyLogs">查看我的订单</a>
    <a href="${pageContext.request.contextPath}/employeeServlet?method=getMyClients">查看我的客户</a>
